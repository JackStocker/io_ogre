...
from . import export
from . import helper
from . import championExport
from . import championExportIcon
...
def auto_register(register):
    ...
    yield from championExport.auto_register(register)
    yield from championExportIcon.auto_register(register)
...
class HT_info_header(bpy.types.Header):
    ...
    def draw(self, context):
        ...
        if not context.area.show_menus:
            ...
            #layout.menu( 'champion_export', icon='MESH_ICOSPHERE', text='' )
            layout.operator( 'champion.export', icon='MESH_ICOSPHERE', text='' )

            #layout.menu( 'champion_export_icon', icon='RENDER_STILL', text='' )
            layout.operator( 'champion.export_icon', icon='RENDER_STILL', text='' )
